...
namespace UnityStandardAssets.Water
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        {
            // If we are using Universal Render Pipeline (URP) or another SRP, 
            // legacy manual Camera.Render calls in OnWillRenderObject are not supported
            // and will cause InvalidOperationException / recursive rendering errors.
