...
namespace DevionGames
{
    ...
    [ComponentMenu("GameObject/BroadcastMessage")]
    [System.Serializable]
    public class BroadcastMessage : Action
    {
        ...
        public override ActionStatus OnUpdate()
        {
            ...
            {
                this.m_TargetÓbject.BroadcastMessage(methodName, m_Argument.GetValue(), m_Options);
            }
            else
            {
                this.m_TargetÓbject.BroadcastMessage(methodName, m_Options);
            }
