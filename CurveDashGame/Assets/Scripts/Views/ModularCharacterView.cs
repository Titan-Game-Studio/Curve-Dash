...
namespace STG.CurveDash
{
    public class ModularCharacterView : MonoBehaviour
    {
        ...
        private void InitializeSlots()
        {
            ...
            // HEADS, CHESTS, ARMS, FEET, LEGS are the expected child names
            ...
            // Feet = boots only (no pants fallback — pants are controlled by Belt slot)
            _slotRoots[EquipmentSlot.Feet]  = armorPartsRoot.Find("FEET") ?? armorPartsRoot.Find("Feet") ?? armorPartsRoot.Find("BOOTS");
            // Belt uses the LEGS (pants) root — equipping a Belt shows pants
            _slotRoots[EquipmentSlot.Belt]  = armorPartsRoot.Find("LEGS") ?? armorPartsRoot.Find("Legs") ?? armorPartsRoot.Find("Pants");
